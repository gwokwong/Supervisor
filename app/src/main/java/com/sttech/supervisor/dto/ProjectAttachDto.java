...
public class ProjectAttachDto extends AbstractMobileDto {
    ...
    public ProjectAttachDto(String createUserId, String createUserName, String createTime, String createUserAvatarPath, String categoryLabel, String content, List<ImageDto> imageList) {
        this.createUserId = createUserId;
        this.createUserName = createUserName;
        this.createTime = createTime;
        this.createUserAvatarPath = createUserAvatarPath;
