...
import com.sttech.supervisor.camera.util.AudioUtil;
...
public class JCameraView extends RelativeLayout implements CameraInterface.CamOpenOverCallback, SurfaceHolder.Callback {
    ...
    public JCameraView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        iconSrc = a.getResourceId(R.styleable.JCameraView_iconSrc, R.drawable.camera_facing);
...
//        return super.onTouchEvent(event);
        ...
        if (event.getPointerCount() == 1 && action == MotionEvent.ACTION_DOWN) {
            ...
            CameraInterface.getInstance().handleFocusMetering(x, y);
//            if (listener != null) {
