 ...
 * data：16/7/27
 */
public class DataGridImageAdapter extends RecyclerView.Adapter<DataGridImageAdapter.ViewHolder> {
    ...
    public DataGridImageAdapter(Context context, onAddPicClickListener mOnAddPicClickListener) {
